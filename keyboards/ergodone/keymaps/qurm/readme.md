Files here are based on the Ordinary layout for ergodox.
This is as similar as reasonable to an "ordinary" layout to reduce cognitive load for switching between this and standard laptop keyboards.
First adapted in 2018 for use with an ErgoDone
Further updated in Feb 2025 to use modern QMK, based on the QMK ergone keymap with my custom layout



Original Ordinary Readme:
